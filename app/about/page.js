    ...
    <div className="min-h-screen bg-white dark:bg-[#121212]">
      ...
      <section className="relative pt-[80px] pb-[60px]">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <div className="inline-flex items-center justify-center h-7 px-[14px] mb-8 rounded-full text-xs font-poppins tracking-[1.3px] uppercase bg-blue-600 from-[#FF7A18] to-[#FFB56B] dark:from-[#FF8A28] dark:to-[#FFC57B] text-white">
            ABOUT US
          </div>
          ...
          <h1 className="text-4xl md:text-5xl font-instrument-sans font-medium text-black dark:text-white mb-6">
            ...
            <br />
            <span className="bg-blue-600 from-[#FF7A18] to-[#FFB56B] dark:from-[#FF8A28] dark:to-[#FFC57B] bg-clip-text text-transparent">
              opportunity
            </span>
          </h1>
      ...
      <div className="max-w-[1200px] mx-auto px-6 pb-16">
            ...
            <div className="bg-gradient-to-br from-[#FF7A18]/10 to-[#FFB56B]/10 dark:from-[#FF8A28]/10 dark:to-[#FFC57B]/10 rounded-2xl p-8 lg:p-12">
              <div className="grid grid-cols-2 gap-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 dark:text-[#FF8A28] mb-2">50K+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Job Seekers</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 dark:text-[#FF8A28] mb-2">1.2K+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Jobs Posted</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 dark:text-[#FF8A28] mb-2">350+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Companies</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 dark:text-[#FF8A28] mb-2">89%</div>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-8 border border-[#E5E5E5] dark:border-[#333333] shadow-sm text-center">
              <div className="w-12 h-12 bg-blue-600 from-[#FF7A18] to-[#FFB56B] dark:from-[#FF8A28] dark:to-[#FFC57B] rounded-xl flex items-center justify-center mx-auto mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-8 border border-[#E5E5E5] dark:border-[#333333] shadow-sm">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-blue-600 from-[#FF7A18] to-[#FFB56B] dark:from-[#FF8A28] dark:to-[#FFC57B] rounded-xl flex items-center justify-center mr-4">
                  <Users className="w-6 h-6 text-white" />
                </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-blue-600 dark:bg-[#FF8A28] rounded-full mt-2 mr-3"></div>
                  <div>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-6 border border-[#E5E5E5] dark:border-[#333333] shadow-sm text-center">
              <div className="w-20 h-20 bg-blue-600 from-[#FF7A18] to-[#FFB56B] dark:from-[#FF8A28] dark:to-[#FFC57B] rounded-full flex items-center justify-center mx-auto mb-4 text-2xl text-white">
                AB
              </div>
              <h3 className="text-xl font-semibold text-black dark:text-white mb-1">Abbey Bakare</h3>
              <p className="text-blue-600 dark:text-[#FF8A28] font-medium mb-3">Founder & CEO</p>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-6 border border-[#E5E5E5] dark:border-[#333333] shadow-sm text-center">
              ...
              <p className="text-blue-600 dark:text-[#FF8A28] font-medium mb-3">Head of Operations</p>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl p-6 border border-[#E5E5E5] dark:border-[#333333] shadow-sm text-center">
              ...
              <p className="text-blue-600 dark:text-[#FF8A28] font-medium mb-3">Lead Developer</p>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
        ...
        {/* Contact Section */}
        <section className="bg-blue-600 from-[#FF7A18] to-[#FFB56B] dark:from-[#FF8A28] dark:to-[#FFC57B] rounded-2xl p-8 md:p-12">
          ...
          <div className="text-center">
            <a href="/post_job" className="inline-flex items-center justify-center h-12 px-8 bg-white text-blue-600 rounded-xl font-inter font-semibold hover:bg-gray-100 transition-colors duration-200">
              Start Hiring Today
            </a>
          </div>
        </section>
